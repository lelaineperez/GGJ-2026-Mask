...
public class PlayerController : MonoBehaviour
{
   ...
   // numbers
    ...
    private bool isTalkingToDeputy;
    private bool npc1Dialogue;
    private bool npc2Dialogue;
    private bool npc3Dialogue;
    private bool npc4Dialogue;
    ...
    {
        if (collider.gameObject.name == "DeputyTrigger")
        {
            isTalkingToDeputy = true;
            isTalkingToGuy = true;
        }
    }
    ...
    {
        if (isTalkingToDeputy == true)
        {
            dialogueText.text = "Detective Clueford, I’m glad you could make it. My guys could really use your help tonight. Petty theft, vandalism, and cold blooded murder. The rest of the team believes they’re close to finding the thief and vandal, but the murder’s got us stumped. The woman over there, her name’s Bianca Red. She said she saw something. Maybe you could get some leads from her.";
        }
